...
def displayplot():
    ...
    fig.suptitle(' Number of vacant seats in different course sectors ', fontsize=35)
    ...
    fig.suptitle(' Number of vacant seats in different college sectors ', fontsize=35)
    ...
    fig=px.sunburst(df, path=['District', 'College Sector'], 
                    values='Vacant Seats')
    # fig.show()
    st.plotly_chart(fig)

    # plt.title('Vacant seats in different course sectors in each district')
    fig=px.sunburst(df, path=['District', 'Course Sector'], 
                    values='Vacant Seats')
    # fig.show()
    st.plotly_chart(fig)
